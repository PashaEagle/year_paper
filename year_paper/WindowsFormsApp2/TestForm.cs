...
namespace WindowsFormsApp2
{
    public partial class TestForm : Form
    {
        ...
        private void TestForm_Load(object sender, EventArgs e)
        {
            ...
            questions.Add(new TestQuestion("З повного набору доміно беруть два каменя. Яка ймовірність того, що другий камінь доміно не можна приставити до першого?", "7/18", "11/18", "0.5", "0.1", 2));
